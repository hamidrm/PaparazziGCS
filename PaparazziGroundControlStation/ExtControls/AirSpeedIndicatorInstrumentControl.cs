...
namespace GCSExtCOntrols
{
    class AirSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(PaparazziGroundControlStation.Properties.Resources.AirSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(PaparazziGroundControlStation.Properties.Resources.AirSpeedNeedle);
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            double alphaNeedle = InterpolPhyToAngle(airSpeed,0,400,180,468);
