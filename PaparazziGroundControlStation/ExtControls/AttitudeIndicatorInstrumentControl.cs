...
namespace GCSExtCOntrols
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(PaparazziGroundControlStation.Properties.Resources.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(PaparazziGroundControlStation.Properties.Resources.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(PaparazziGroundControlStation.Properties.Resources.Maquette_Avion);
