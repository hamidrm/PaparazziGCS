...
namespace GCSExtCOntrols
{
    class AltimeterInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(PaparazziGroundControlStation.Properties.Resources.Altimeter_Background);
        Bitmap bmpSmallNeedle = new Bitmap(PaparazziGroundControlStation.Properties.Resources.SmallNeedleAltimeter);
        Bitmap bmpLongNeedle = new Bitmap(PaparazziGroundControlStation.Properties.Resources.LongNeedleAltimeter);
        Bitmap bmpScroll = new Bitmap(PaparazziGroundControlStation.Properties.Resources.Bandeau_Derouleur);
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            double alphaSmallNeedle = InterpolPhyToAngle(altitude,0,500,0,359);
            double alphaLongNeedle = InterpolPhyToAngle(altitude%500,0,500,0,359);

            float scale = (float)this.Width / bmpCadran.Width;

            // display counter
            ScrollCounter(pe, bmpScroll, 5, (int)altitude, ptCounter, scale);
