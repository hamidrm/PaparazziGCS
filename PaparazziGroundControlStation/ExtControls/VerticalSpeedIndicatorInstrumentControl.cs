...
namespace GCSExtCOntrols
{
    class VerticalSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(PaparazziGroundControlStation.Properties.Resources.VerticalSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(PaparazziGroundControlStation.Properties.Resources.VerticalSpeedNeedle);
