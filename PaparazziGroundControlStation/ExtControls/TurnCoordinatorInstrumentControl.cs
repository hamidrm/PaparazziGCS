...
namespace GCSExtCOntrols
{
    class TurnCoordinatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(PaparazziGroundControlStation.Properties.Resources.TurnCoordinator_Background);
        Bitmap bmpBall = new Bitmap(PaparazziGroundControlStation.Properties.Resources.TurnCoordinatorBall);
        Bitmap bmpAircraft = new Bitmap(PaparazziGroundControlStation.Properties.Resources.TurnCoordinatorAircraft);
        Bitmap bmpMarks = new Bitmap(PaparazziGroundControlStation.Properties.Resources.TurnCoordinatorMarks);
