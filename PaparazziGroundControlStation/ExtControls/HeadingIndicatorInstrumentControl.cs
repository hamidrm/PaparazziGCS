...
namespace GCSExtCOntrols
{
    class HeadingIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(PaparazziGroundControlStation.Properties.Resources.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(PaparazziGroundControlStation.Properties.Resources.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(PaparazziGroundControlStation.Properties.Resources.HeadingIndicator_Aircraft);        
